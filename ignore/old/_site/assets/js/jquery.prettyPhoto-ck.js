...
(function ($) {
  ...
  $.fn.prettyPhoto = function (pp_settings) {
    ...
    var matchedObjects = this,
      percentBased = false,
      pp_dimensions, pp_open, pp_contentHeight, pp_contentWidth, pp_containerHeight, pp_containerWidth, windowHeight = $(window)
        .height(),
      windowWidth = $(window)
        .width(),
      pp_slideshow;
    ...
    $.prettyPhoto.initialize = function () {
      ...
      set_position = jQuery.inArray($(this)
        .attr('href'), pp_images);
      rel_index = (isSet) ? set_position : $("a[" + settings.hook + "^='" + theRel + "']")
        .index($(this));
      _build_overlay(this);
    ...
    $.prettyPhoto.open = function (event) {
      ...
      $pp_pic_holder.find('.currentTextHolder')
        .text((set_position + 1) + settings.counter_separator_label + $(pp_images)
          .size());
      ...
      if (movie_height.indexOf('%') != -1) {
        movie_height = parseFloat(($(window)
          .height() * parseFloat(movie_height) / 100) - 150);
        percentBased = true;
      }
      if (movie_width.indexOf('%') != -1) {
        movie_width = parseFloat(($(window)
      ...
      $pp_pic_holder.fadeIn(function () {
        ...
        case 'image':
          ...
          nextImage = new Image();
          if (isSet && set_position < $(pp_images)
        ...
        case 'youtube':
          ...
          toInject = settings.iframe_markup.replace(/{width}/g, pp_dimensions['width'])
        ...
        case 'quicktime':
          ...
          toInject = settings.quicktime_markup.replace(/{width}/g, pp_dimensions['width'])
            .replace(/{height}/g, pp_dimensions['height'])
            .replace(/{wmode}/g, settings.wmode)
        ...
        case 'flash':
          ...
          toInject = settings.flash_markup.replace(/{width}/g, pp_dimensions['width'])
            .replace(/{height}/g, pp_dimensions['height'])
            .replace(/{wmode}/g, settings.wmode)
        ...
        case 'inline':
          myClone = $(pp_images[set_position])
            ...
            .show();
          doresize = false;
          pp_dimensions = _fitToViewport($(myClone)
            .width(), $(myClone)
            .height());
          doresize = true;
          $(myClone)
            .remove();
          toInject = settings.inline_markup.replace(/{content}/g, $(pp_images[set_position])
            .html());
          break;
        };
    ...
    $.prettyPhoto.changePage = function (direction) {
      ...
      if (direction == 'previous') {
        set_position--;
        if (set_position < 0) set_position = $(pp_images)
          .size() - 1;
      } else if (direction == 'next') {
        set_position++;
        if (set_position > $(pp_images)
    ...
    function _getDimensions(width, height) {
      ...
      pp_containerHeight = pp_contentHeight + titleHeight + $pp_pic_holder.find('.pp_top')
    ...
    function _resize_overlay() {
      windowHeight = $(window)
        .height(), windowWidth = $(window)
        .width();
      if (typeof $pp_overlay != "undefined") $pp_overlay.height($(document)
        .height())
        .width(windowWidth);
    };
    ...
    function _build_overlay(caller) {
      ...
      if (isSet && settings.overlay_gallery) {
        ...
        for (var i = 0; i < pp_images.length; i++) {
          ...
          toInject += "<li class='" + classname + "'><a href='#'><img class="
          img - responsive "  src='" + img_src + "' width='50' alt='' /></a></li>";
        };
    ...
    return this.unbind('click.prettyphoto')
      .bind('click.prettyphoto', $.prettyPhoto.initialize);
  };

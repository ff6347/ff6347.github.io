...
Small research/proof of concept project together with CityLAB Berlin. A force directed graph view to gradually explore [oparl data](https://oparl.org). (Not public yet)

- **Years:** 2025
- **Context:** Technologiestiftung Berlin, CityLAB Berlin, Freelance
...
Low-cost, privacy-respecting real-time traffic counting using open-source AI. This project used the [OpenDataCam](https://opendata.cam) as the basis. We did some more on device analysis. [See the GitHub Topic](https://github.com/topics/opentrafficcount)
...
A Node.js CLI tool to convert HTML to Markdown. It uses Turndown as parser. You can find the repo [on GitHub](https://github.com/ff6347/to-markdown-cli).
...
<iframe
	src="https://player.vimeo.com/video/54717636?loop=1"
	width="100%"
	height="232"
	frameborder="0"
...
<iframe
	src="https://player.vimeo.com/video/53158182?loop=1"
	width="100%"
	height="232"
	frameborder="0"
	webkitallowfullscreen
...
<iframe
	src="https://player.vimeo.com/video/64222693?loop=1"
	width="100%"
	height="232"
	frameborder="0"
	webkitallowfullscreen
...
<iframe
	src="https://player.vimeo.com/video/39960358?loop=1"
	width="100%"
	height="232"
	frameborder="0"
	webkitallowfullscreen

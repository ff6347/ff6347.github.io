...
**Prototyping Machines @FHP University of Applied Sciences Potsdam.**
...
See the [resulting projects here](https://prototyping-machines.qawsed.site/).
...
<div class="thumbs">
	<a href="https://github.com/Q-rec/mitte-zur-mitte">
		<Image
			src={mitte}
			alt="Mitte zur Mitte"
			width={400}
	...
	<a href="https://github.com/vogelino/molecular-networks-p5-algorithm">
		<Image
			src={molecule}
			alt="Molecular Networks"
			width={400}
			height={300}
			quality={80}
			format="webp"
	...
	<a href="https://github.com/topada/FHP-IO-topolade-algorithm">
		<Image
			src={topolade}
			alt="Topolade"
			width={400}
	...
	<a href="https://github.com/Ninotschka/outlines">
		<Image
			src={puzzle}
			alt="Puzzle"
			width={400}
...
<div class="thumbs">
	<a href="https://github.com/vogelino/explore-with-iss">
		<Image
			src={explore}
			alt="Explore with ISS"
			width={400}
			height={300}
			quality={80}
			format="webp"
	...
	<a href="https://github.com/topada/FHP-IO-galton-board-physarum">
		<Image
			src={galton}
			alt="Galton Board Physarum"
			width={400}
			height={300}
			quality={80}
			format="webp"
	...
	<a href="http://projects.kevinschiffer.de/flag-survey-datavis/">
		<Image
			src={flags}
			alt="Flags"
			width={400}
	...
	<a href="https://github.com/josues/relativity-and-iss">
		<Image
			src={relativ}
			alt="Relativity and ISS"
			width={400}
			height={300}
			quality={80}
			format="webp"
...
<iframe
	src="https://player.vimeo.com/video/157480156?loop=1"
	frameborder="0"
...
<iframe
	src="https://player.vimeo.com/video/123418651?loop=1"
	frameborder="0"
	webkitallowfullscreen
	mozallowfullscreen
	allowfullscreen
...
<iframe
	src="https://player.vimeo.com/video/123883583?loop=1"
	frameborder="0"
	webkitallowfullscreen
	mozallowfullscreen
	allowfullscreen
...
<div class="thumbs">
	<a href="/assets/images/teaching/papercraft/papercraft-00.jpg">
		<Image
			src={papercraft}
			alt="Papercraft"
			width={400}
	...
	<a href="/assets/images/teaching/papercraft/papercraft-01.jpg">
		<Image
			src={papercraft2}
			alt="Papercraft"
			width={400}
...
<div class="thumbs">
	<a href="/assets/images/teaching/papercraft/papercraft-02.jpg">
		<Image
			src={papercraft3}
			alt="Papercraft"
			width={400}
	...
	<a href="/assets/images/teaching/papercraft/papercraft-03.jpg">
		<Image
			src={papercraft4}
			alt="Papercraft"
			width={400}
...
<div class="thumbs">
	<a href="/assets/images/teaching/projection/projection-01.jpg">
		<Image
			src={projection}
			alt="Projection"
			width={400}
	...
	<a href="/assets/images/teaching/projection/projection-02.jpg">
		<Image
			src={projection2}
			alt="Projection"
			width={400}
...
<a href="/assets/images/teaching/projection/projection-03.jpg">
	<Image
		src={projection3}
		alt="Projection"
		width={400}
...
<a href="/assets/images/teaching/projection/projection-04.jpg">
	<Image
		src={projection4}
		alt="Projection"
		width={400}
...
<div class="thumbs">
	<a href="https://github.com/RahelFl/M2M-Translator">
		<Image
			src={m2m}
			alt="M2M Translator"
			width={400}
	...
	<iframe
		src="https://player.vimeo.com/video/144001575"
		width="100%"
		height="232"
		frameborder="0"
		webkitallowfullscreen
...
<div class="thumbs">
	<a href="https://github.com/vogelino/nibble-do-list">
		<Image
			src={nibble}
			alt="Nibble Do List"
			width={400}
...
<iframe
	src="https://player.vimeo.com/video/143141941?loop=1"
	width="100%"
	height="232"
	frameborder="0"
	webkitallowfullscreen
...
<div class="thumbs">
	<a href="https://github.com/chrisklement/treat-spin">
		<Image
			src={mockup}
			alt="Mockup"
			width={400}
...
<iframe
	src="https://player.vimeo.com/video/113909158?loop=1"
	width="100%"
	height="232"
	frameborder="0"
	webkitallowfullscreen
...
<div class="thumbs flex flex-wrap">
	<Image
		...
		format="webp"
	/>
	<a href="/assets/images/teaching/blockseminar/quartet-02.png">
		<Image
			src={quartet2}
			alt="quartet jk"
			width={400}
...
<div class="thumbs">
	<Image
		src={interactiveplant}
		alt="Interactive Plant"
		width={400}
		height={300}
		quality={80}
		format="webp"
...
<div class="thumbs">
	<a href="http://ff6347.github.io/Typography-And-Automation/">
		<Image
			src={auto}
			alt="Typography and Automation"
			width={400}
			height={300}
			quality={80}
			format="webp"
	...
	<a href="http://ff6347.github.io/Typography-And-Automation/skaim.html">
		<Image
			src={auto2}
			alt="Typography and Automation"
			width={400}
...
<div class="thumbs">
	<a href="http://ff6347.github.io/Typography-And-Automation/johannahoeflich.html">
		<Image
			src={auto6}
			alt="Typography and Automation"
			width={400}
	...
	<a href="http://ff6347.github.io/Typography-And-Automation/schlompf.html">
		<Image
			src={auto8}
			alt="Typography and Automation"
			width={400}
...
<div class="thumbs">
	<iframe
		src="https://player.vimeo.com/video/48392006?loop=1&byline=0&portrait=0"
		width="100%"
		height="232"
		frameborder="0"
		webkitallowfullscreen
